...
class Shortly(object):
    ...
    def insert_url(self, url):
        ...
        if short_id is not None:
            return short_id
        url_num = self.redis_incr('last-url-id')
...
def base36_encode(number):
    ...
    while number != 0:
        ...
        base36.append('0123456789abacdefghijklmnopqrstuvwxyz'[i])
    return ''.join(reversed(base36))
    

def create_app(redis_host='localhost', redis_port=6479, with_static=True):
    app = Shortly({
